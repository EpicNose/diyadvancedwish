...
public class ScriptUtils {
    ...
    public static void setup() {
        ...
        rhino.evaluateString(GLOBAL_SCOPE, "const Main = Packages.twomillions.plugin.advancedwish.Main.getInstance()", "RhinoJs", 1, null);
        rhino.evaluateString(GLOBAL_SCOPE, "const plugin = Packages.twomillions.plugin.advancedwish.Main.getInstance()", "RhinoJs", 1, null);
